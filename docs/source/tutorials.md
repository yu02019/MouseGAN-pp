...
![figure_loss_curve](_static/loss_curve.png)
...
|------------|----------------------------------------|----------------|
| MouseGAN++ | ![](_static/outputE_76.png)            | T2*w -> Others |
| MouseGAN++ | ![](_static/outputD_80.png)            | T2w -> Others  |
| MouseGAN++ | ![](_static/outputC_66.png)            | T1w -> Others  |
| StarGAN-v2 | ![](_static/050000_latent_psi_1.0.jpg) | -              |

Some <font color=red>failed</font> cases:

| Methods    | Input image                    | Real image                    | <font color=red>Failed</font> Synthetic image | Modality   |
|------------|--------------------------------|-------------------------------|-----------------------------------------------|------------|
| MouseGAN++ | ![](_static/input-T1-025+.png) | ![](_static/real-T2-025+.png) | ![](_static/output-T2-025+.png)               | T1w -> T2w |
| MouseGAN++ | ![](_static/input-T1-034+.png) | ![](_static/real-T2-034+.png) | ![](_static/output-T2-034+.png)               | T1w -> T2w |
| StarGAN-v2 | ![](_static/input-T1-028.png)  | ![](_static/real-T2-028.png)  | ![](_static/output-T2-028-StarGAN.png)        | T1w -> T2w |
| StarGAN-v2 | ![](_static/input-T1-034.png)  | ![](_static/real-T2-034.png)  | ![](_static/output-T2-034-StarGAN.png)        | T1w -> T2w |
...
|         | T1 -> T2                       | T2 -> T1                       |
|---------|--------------------------------|--------------------------------|
| Results | ![](_static/ablation_t1t2.png) | ![](_static/ablation_t2t1.png) |
